        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Dirección y datos del consultorio",
                        verbose_name="información del consultorio",
                    ),
                ),
                (
                    "precio_consulta",
                    models.DecimalField(
                        decimal_places=2,
                        default=0,
                        help_text="Precio de la consulta médica",
                        max_digits=10,
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Indica si ofrece atención virtual",
                        verbose_name="atención online",
                    ),
                ),
                (
                    "calificacion",
                    models.DecimalField(
                        decimal_places=2,
                        default=0.0,
                        help_text="Calificación promedio del médico",
                        max_digits=3,
                        validators=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "fecha",
                    models.DateField(
                        help_text="Fecha del horario disponible", verbose_name="fecha"
                    ),
                ),
                (
                    "hora_inicio",
                    models.TimeField(
                        help_text="Hora de inicio del turno", verbose_name="hora inicio"
                    ),
                ),
                (
                    "hora_fin",
                    models.TimeField(help_text="Hora de fin del turno", verbose_name="hora fin"),
                ),
                (
                    "disponible",
                    models.BooleanField(
                        default=True,
                        help_text="Indica si el turno está disponible",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Indica si esta es la especialidad principal del médico",
