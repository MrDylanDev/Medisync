...
urlpatterns = [
    ...
    path(
        "dashboard/usuarios/<int:pk>/bloquear/",
        views_frontend.admin_bloquear_usuario_frontend,
        name="admin-usuario-bloquear-frontend",
    ),
    path(
        "dashboard/usuarios/<int:pk>/activar/",
        views_frontend.admin_activar_usuario_frontend,
        name="admin-usuario-activar-frontend",
    ),
    path(
        "dashboard/usuarios/<int:pk>/eliminar/",
        views_frontend.admin_eliminar_usuario_frontend,
        name="admin-usuario-eliminar-frontend",
    ),
    # Frontend — reportes
    ...
    path(
        "api/admin/usuarios/<int:pk>/bloquear/",
        accounts_views.admin_bloquear_usuario,
        name="admin-usuario-bloquear",
    ),
    path(
        "api/admin/usuarios/<int:pk>/activar/",
        accounts_views.admin_activar_usuario,
        name="admin-usuario-activar",
    ),
    path(
        "api/admin/usuarios/<int:pk>/eliminar/",
        accounts_views.admin_eliminar_usuario,
